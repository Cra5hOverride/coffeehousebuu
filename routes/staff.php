...
Route::group(['prefix' => 'staff', 'middleware' => ['login']], function(){
    ...
    Route::get('/addbill', 'Web\StaffController@addBill')->name('staff.addBill');
    ...
    Route::post('/addorderproduct', 'Web\StaffController@addOrderProduct')->name('staff.addorderproduct');
});